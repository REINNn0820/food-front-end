...
export const Navigation = () => {
  ...
  const isSelectedMenu =
    splitedName[2] === "menu" && "bg-primary text-primary-foreground";
  const isSelectedOrders =
    splitedName[2] === "orders" && "bg-primary text-primary-foreground";
    ...
    <div className="h-screen py-9 px-5 flex flex-col gap-10 bg-background ">
      ...
      <div className="flex flex-col w-[165px] gap-6 ">
        <Link href={`/admin/menu`}>
          <button
            className={`flex px-6 py-2 ${isSelectedMenu} items-center gap-[10px] rounded-full`}
          >
        ...
        <button
          className={`flex px-6 py-2 ${isSelectedOrders} items-center gap-[10px] rounded-full`}
        >
          <Truck strokeWidth={1} />
          <h3 className="text-sm font-medium  ">Orders</h3>
        </button>
        <button
          className={`flex px-6 py-2 ${isSelectedSettings} items-center gap-[10px] rounded-full`}
        >
